...
namespace AutoBalooWeb.WebForms
{
    public partial class MainPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            list = ((Modele)Session["CoucheModele"]).ListVehiculeVMAvecOptions(1);
            ...
            while (i < list.Count())
            {
                ...
                //Si Achat ou location l'affichage diffère. --Si 0 vente Si 1 Location
                ...
                cph.Controls.Add(new LiteralControl(
                    ...
                    ((c.Reduction == 0) ? "<div>" + c.Prix + "€" + ((c.TypeTransaction == 0) ? "" : " par jour")+"</div>\r\n" : "<div><strike>" + c.Prix + "</strike> " + (c.Prix - (c.Prix * c.Reduction) / 100) + "€" + ((c.TypeTransaction == 0) ? "" : " par jour") +" </div>\r\n")));
