    ...
    <div class="form">
        ...
        <div>
            <div class="input-group">
                ...
                <asp:TextBox ID="txtNom" runat="server" class="form-control" placeholder="Entrer Nom"/>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtEmail" runat="server" TextMode="Email" class="form-control" placeholder="Entrer Email"
            ...
            <div class="input-group">
                ...
                <asp:TextBox ID="txtPwd"  runat="server" TextMode="Password" ToolTip="Mot de passe doit contenir: Minimum 8 caracteres at-least 1 Alphabet and 1 Number"
                    class="form-control" placeholder="Entrer mot de passe" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$"/>
            </div>       
            <div class="input-group">
