...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHContenu" runat="server">
    <asp:Login 
        ...
        runat="server" 
        BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" Height="199px" style="margin-left: 666px; margin-top: 120px" Width="306px" 
